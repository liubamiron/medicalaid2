                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/1/istoria">Istoria</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/2/ingrijiri-comunitare">Ingrijiri comunitare</a></li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/legislatie" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Legislatie
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="/donatii" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Donatii
                            </a>
                        </li>

                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="/parteneriat" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Parteneriat
                            </a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/colaborare">Colaborare</a></li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/contacte" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Contacte
                            </a>
                        </li>
